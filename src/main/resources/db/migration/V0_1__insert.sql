...
INSERT INTO users
VALUES (0, 'john.doe@example.com', 'password123', 'John', 'Doe', current_timestamp),
       (1, 'jane.smith@example.com', 'securePass!', 'Jane', 'Smith', current_timestamp),
       (2, 'alice.jones@example.com', 'qwerty123', 'Alice', 'Jones', current_timestamp),
       (3, 'bob.brown@example.com', '123456789', 'Bob', 'Brown', current_timestamp);